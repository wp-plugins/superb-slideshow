...
function sswld_admin_option() 
{
	...
	<h2><?php echo wp_specialchars( 'How to add more image? .' ); ?></h2>
	...
	<a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/superb-slideshow/'>Click here</a> to see More information.<br />
    <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/superb-slideshow/'>Click here</a> to post suggestion or comments or feedback.<br />
    <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/superb-slideshow/'>Click here</a> to see live demo & more info.<br />
    <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/superb-slideshow/'>Click here</a> to download my other plugins.<br />
    </p>
	<?php
	echo "</div>";
}
