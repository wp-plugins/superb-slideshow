...
function sswld_admin_option() 
{
    ...
    <h2>About Plugin</h2>
    Plug-in created by <a target="_blank" href='http://www.gopipulse.com/work/2010/07/18/superb-slideshow/'>www.gopipulse.com</a><br />
	Check official website for more info <a target="_blank" href='http://www.gopipulse.com/work/2010/07/18/superb-slideshow/'>www.gopipulse.com</a><br />    </p>
	<?php
	echo "</div>";
}
...
function sswld_add_javascript_files() 
{
	if (!is_admin())
	{
		wp_enqueue_script( 'jquery.min', get_option('siteurl').'/wp-content/plugins/superb-slideshow/inc/jquery.min.js');
