...
function sswld_admin_option() 
{
	...
	echo $sswld_width . '" name="sswld_width" id="sswld_width" />Only Number</p>';
	
	echo '<p>Height:<br><input  style="width: 100px;" maxlength="4" type="text" value="';
	echo $sswld_height . '" name="sswld_height" id="sswld_height" />Only Number</p>';
	...
	<code>
		&lt;image&gt;<br>
		&nbsp;&nbsp;&nbsp;&nbsp;	&lt;path&gt;wp-content/plugins/superb-slideshow/images/gSlide11.jpg&lt;/path&gt;<br>
